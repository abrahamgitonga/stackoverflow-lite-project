...
import WhoAndWhen from "../User/WhoAndWhen";
import UserLink from "../User/UserLink";
import VotingButtons from "../Button/VotingButtons";
import Comments from "../Comment/Comments";
import Header2 from "../Header/Header2";
import PostBodyTextarea from "../Common/PostBodyTextarea";
import BlueButton from "../Button/BlueButton";
import When from "../User/When";
...
function QuestionPage({match}) {
  ...
  const getQuestion = useCallback(() => {
    axios.get('http://localhost:3030/questions/questions/'+match.params.id, {withCredentials:true})
      .then(response => {
    ...
    <>
      <Container>
        {question && (
          <>
            <Helmet>
              <title>{question.title} - StackOverflowLite</title>
            </Helmet>
